  ...
  return (
    <>
      <button
        type="button"
        onClick={openModal}
        className={`flex h-full items-center justify-center rounded-md text-sm`}
      >
        <EditInactiveIcon className="mr-2 h-6 w-6" aria-hidden="true" />
      </button>
