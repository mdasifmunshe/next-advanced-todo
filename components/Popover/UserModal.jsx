...
export default function UserModal() {
    return (
        <div className="fixed -right-2 sm:right-2 lg:right-4 top-3 max-w-sm px-4">
            <Popover className="relative">
                {({ open }) => (
                  ...
                  ml-2 h-5 w-5 text-indigo-300 transition duration-150 ease-in-out hover:text-white group-hover:text-opacity-80`}
                        ...
                        >
                            <Popover.Panel className="absolute -right-24 z-10 mt-3 w-screen max-w-[12rem] -translate-x-1/2 transform px-4 sm:px-0">
